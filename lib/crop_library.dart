...
const vegetableLibrary = [
  ...
  VegetableDefinition(
    ...
    iconPath: 'assets/veg_icons/v9_bell_pepper.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'solanaceae',
    name: 'Chilli',
    iconPath: 'assets/veg_icons/v9_chili_pepper.svg',
    commonPests: ['Aphids', 'Thrips', 'Whitefly', 'Mites'],
  ...
  VegetableDefinition(
    ...
    familyId: 'solanaceae',
    name: 'Eggplant',
    iconPath: 'assets/veg_icons/v9_eggplant.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'solanaceae',
    name: 'Potato',
    iconPath: 'assets/veg_icons/v9_potato.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'brassicas',
    name: 'Cauliflower',
    iconPath: 'assets/veg_icons/v9_cauliflower.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'brassicas',
    name: 'Cabbage',
    iconPath: 'assets/veg_icons/v9_cabbage.svg',
    commonPests: [
      'Cabbage white caterpillar',
      'Aphids',
      'Flea beetles',
  ...
  VegetableDefinition(
    ...
    familyId: 'brassicas',
    name: 'Kale',
    iconPath: 'assets/veg_icons/v9_kale.svg',
    commonPests: [
      'Aphids',
      'Cabbage white caterpillar',
      'Whitefly',
  ...
  VegetableDefinition(
    ...
    iconPath: 'assets/veg_icons/v9_bok_choy.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'brassicas',
    name: 'Rocket / Arugula',
    iconPath: 'assets/veg_icons/v9_turkish_rocket.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'alliums',
    name: 'Garlic',
    iconPath: 'assets/veg_icons/v9_garlic.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'alliums',
    name: 'Leek',
    iconPath: 'assets/veg_icons/v9_leek.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'alliums',
    name: 'Spring onion',
    iconPath: 'assets/veg_icons/v9_green_onion.svg',
    commonPests: ['Thrips', 'Aphids'],
    commonDiseases: ['Rust', 'Downy mildew', 'Rot'],
  ...
  VegetableDefinition(
    ...
    familyId: 'alliums',
    name: 'Chives',
    iconPath: 'assets/veg_icons/v9_chives.svg',
    commonPests: ['Thrips', 'Aphids'],
  ...
  VegetableDefinition(
    ...
    familyId: 'cucurbits',
    name: 'Cucumber',
    iconPath: 'assets/veg_icons/v9_cucumber.svg',
  ...
  VegetableDefinition(
    ...
    iconPath: 'assets/veg_icons/v9_zucchini.svg',
  ...
  VegetableDefinition(
    ...
    iconPath: 'assets/veg_icons/v9_melon.svg',
    commonPests: ['Aphids', 'Whitefly', 'Mites', 'Caterpillars'],
    commonDiseases: ['Powdery mildew', 'Downy mildew', 'Rot'],
    preventativeTips: [
      'Grow warm and sunny',
  ...
  VegetableDefinition(
    ...
    familyId: 'legumes',
    name: 'Beans',
    iconPath: 'assets/veg_icons/v9_runner_bean.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'legumes',
    name: 'Broad beans',
    iconPath: 'assets/veg_icons/v9_broad_bean.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'leafy_greens',
    name: 'Spinach',
    iconPath: 'assets/veg_icons/v9_spinach.svg',
  ...
  VegetableDefinition(
    ...
    iconPath: 'assets/veg_icons/v9_swiss_chard.svg',
    commonPests: ['Aphids', 'Slugs', 'Leaf miners'],
  ...
  VegetableDefinition(
    ...
    familyId: 'root_vegetables',
    name: 'Beetroot',
    iconPath: 'assets/veg_icons/v9_beetroot.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'root_vegetables',
    name: 'Radish',
    iconPath: 'assets/veg_icons/v9_radish.svg',
    commonPests: ['Flea beetles', 'Aphids', 'Slugs'],
  ...
  VegetableDefinition(
    ...
    familyId: 'root_vegetables',
    name: 'Parsnip',
    iconPath: 'assets/veg_icons/v9_parsnip.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'apiaceae',
    name: 'Parsley',
    iconPath: 'assets/veg_icons/v9_parsley.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'apiaceae',
    name: 'Coriander',
    iconPath: 'assets/veg_icons/v9_cilantro.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'apiaceae',
    name: 'Fennel',
    iconPath: 'assets/veg_icons/v9_fennel.svg',
  ...
  VegetableDefinition(
    ...
    name: 'Basil',
    iconPath: 'assets/veg_icons/v9_basil.svg',
    commonPests: ['Aphids', 'Whitefly', 'Slugs'],
    commonDiseases: ['Downy mildew', 'Leaf spot', 'Root rot'],
    preventativeTips: [
      'Plant near tomatoes',
      'Keep leaves dry overnight',
      'Pinch flowers for leaf growth',
    ],
    maintenanceTips: ['Harvest tips often', 'Water consistently'],
  ),
  VegetableDefinition(
    id: 'mint',
    familyId: 'herbs',
    name: 'Mint',
    iconPath: 'assets/veg_icons/v9_mint.svg',
    commonPests: ['Aphids', 'Spider mites', 'Flea beetles'],
    commonDiseases: ['Rust', 'Powdery mildew', 'Leaf spot'],
    preventativeTips: [
      'Grow in a contained pot',
      'Cut back crowded stems',
      'Avoid drought stress',
    ],
    maintenanceTips: ['Harvest regularly', 'Remove rusty leaves'],
  ),
  VegetableDefinition(
    id: 'oregano',
    familyId: 'herbs',
    name: 'Oregano',
    iconPath: 'assets/veg_icons/v9_oregano.svg',
    ...
    maintenanceTips: ['Harvest young stems', 'Keep airy'],
  ),
  VegetableDefinition(
    id: 'rosemary',
    familyId: 'herbs',
    name: 'Rosemary',
    iconPath: 'assets/veg_icons/v9_rosemary.svg',
    ...
    maintenanceTips: ['Harvest woody tips lightly', 'Do not overfeed'],
  ),
  VegetableDefinition(
    id: 'sage',
    familyId: 'herbs',
    name: 'Sage',
    iconPath: 'assets/veg_icons/v9_sage.svg',
    ...
    maintenanceTips: ['Harvest sparingly', 'Refresh old plants'],
  ),
  VegetableDefinition(
    id: 'thyme',
    familyId: 'herbs',
    name: 'Thyme',
    iconPath: 'assets/veg_icons/v9_thyme.svg',
    commonPests: ['Aphids', 'Spider mites'],
    commonDiseases: ['Root rot', 'Leaf spot'],
    preventativeTips: [
      'Use gritty free-draining soil',
      'Do not overwater',
      'Trim after flowering',
    ],
    maintenanceTips: ['Harvest small sprigs', 'Keep compact'],
  ),
  VegetableDefinition(
    id: 'dill',
    familyId: 'herbs',
    name: 'Dill',
    iconPath: 'assets/veg_icons/v9_dill.svg',
    commonPests: ['Aphids', 'Caterpillars'],
    commonDiseases: ['Powdery mildew', 'Leaf spot'],
    preventativeTips: [
      'Sow successively',
      'Keep evenly watered',
      'Let some plants flower for beneficial insects',
    ],
    maintenanceTips: ['Harvest fronds young', 'Stake if windy'],
  ),
  VegetableDefinition(
    id: 'sweetcorn',
  ...
  VegetableDefinition(
    ...
    iconPath: 'assets/veg_icons/v9_sweet_potato.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'specialty',
    name: 'Okra',
    iconPath: 'assets/veg_icons/v9_okra.svg',
    commonPests: ['Aphids', 'Whitefly', 'Mites', 'Caterpillars'],
  ...
  VegetableDefinition(
    ...
    familyId: 'berries',
    name: 'Raspberry',
    iconPath: 'assets/veg_icons/v9_raspberry_bush.svg',
  ...
  VegetableDefinition(
    ...
    familyId: 'berries',
    name: 'Blueberry',
    iconPath: 'assets/veg_icons/v9_blueberry_bush.svg',
